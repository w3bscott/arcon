...
export default function CorePage() {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-foreground">Reactive Stores</h2>
        <p className="text-muted-foreground leading-7">
        ...
        <h3 className="text-xl font-medium tracking-tight text-foreground mt-4">Using a Store Directly</h3>
        <CodeBlock code={storeCode} language="typescript" />
      </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-foreground">Formatters & Utilities</h2>
        <p className="text-muted-foreground leading-7">
