...
export default function StylingPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight text-[#09090b]">Styling</h1>
      <p className="text-lg text-[#71717a]">
        Arc UI components are completely unstyled by default. You have full control over the visual presentation.
      </p>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">The className Prop</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">State Management via Data Attributes</h2>
        <p className="text-[#71717a] leading-7">
        ...
        <h3 className="text-xl font-medium tracking-tight text-[#09090b] mt-6">Example: Vanilla CSS</h3>
        <CodeBlock code={stylingCode} language="css" />

        <h3 className="text-xl font-medium tracking-tight text-[#09090b] mt-6">Example: Tailwind CSS</h3>
        <CodeBlock code={tailwindCode} language="tsx" />
      </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">Modifying the Source</h2>
        <p className="text-[#71717a] leading-7">
