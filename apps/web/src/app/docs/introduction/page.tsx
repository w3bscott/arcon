...
export default function IntroductionPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight text-[#09090b]">Introduction</h1>
      <p className="text-lg text-[#71717a]">
        Beautifully designed, accessible React components for Circle's Arc App Kit.
      </p>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">What is Arc UI?</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">Why this approach?</h2>
        <p className="text-[#71717a] leading-7">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">Architecture</h2>
        <p className="text-[#71717a] leading-7">
