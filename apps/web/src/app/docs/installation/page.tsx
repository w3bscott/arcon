...
export default function InstallationPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight text-[#09090b]">Installation</h1>
      <p className="text-lg text-[#71717a]">
        How to install dependencies and structure your app.
      </p>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">1. Install the Core Package</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">2. Setup the App Kit</h2>
        <p className="text-[#71717a] leading-7">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">3. Add Components</h2>
        <p className="text-[#71717a] leading-7">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight text-[#09090b]">4. Use the Components</h2>
        <p className="text-[#71717a] leading-7">
